...
static SkPath create_path_46() {
    ...
    path.lineTo(-163.5308380126953125, -1.7014117331926442991e+38);
    path.lineTo(-4.0384349337320223827e+35, -1.700227037647695005e+38);
    path.lineTo(4.0384349337320223827e+35, 1.700227037647695005e+38);
    path.lineTo(-163.5308380126953125, 1.7014117331926442991e+38);
    path.lineTo(-7.4250776800239202837e+36, 1.2379291628432303167e+38);
    path.lineTo(-1.0321827899075254821e+37, 5.1199920965387697886e+37);
    ...
    path.lineTo(1.0425214946728668754e+37, -4.5731834042267216669e+37);
    path.moveTo(-1.0795449417808426232e+37, -1.2246856113744539311e+37);
    path.lineTo(-1.0823525343302281057e+37,             3.703125);
    path.lineTo(-9.5077331762291841872e+36, 8.1304868292377430302e+37);
    path.lineTo(-8.9654062626142429706e+36, 9.5321017307776115323e+37);
    path.lineTo(8.9654062626142429706e+36, -9.5321017307776115323e+37);
    path.lineTo(9.5077331762291841872e+36, -8.1304868292377430302e+37);
    path.lineTo(1.0823525343302281057e+37,             3.703125);
    path.lineTo(1.0795449417808426232e+37, 1.2246856113744539311e+37);
    path.lineTo(-1.0795449417808426232e+37, -1.2246856113744539311e+37);
    path.moveTo(5.3532263698844015793e+36, 1.4787401838264262345e+38);
    path.lineTo(5.7267307456874477748e+36, 1.4437487679541103361e+38);
    path.lineTo(-165.8018341064453125,           -44.859375);
    path.lineTo(1.0733475247613868325e+37, 2.190164309785319925e+37);
    path.lineTo(1.0733475247613868325e+37, 2.190164309785319925e+37);
    path.lineTo(-1.0733475247613868325e+37, -2.190164309785319925e+37);
    path.lineTo(-1.0733475247613868325e+37, -2.1901645633154399706e+37);
    path.lineTo(-1.0690885990398000502e+37, -2.6554643361532931244e+37);
    path.lineTo(-1.0640136866268463566e+37, -3.1187371356813813394e+37);
    path.lineTo(-1.0581264637092664136e+37, -3.5796290338521208939e+37);
    path.lineTo(-1.0514314938292210428e+37, -4.0377883843890084771e+37);
    path.lineTo(-1.0439337842065811458e+37, -4.492865062196261052e+37);
    path.lineTo(-1.0356391660341077723e+37, -4.9445117310094160839e+37);
    path.lineTo(-1.0265539775648020636e+37, -5.3923838433953315398e+37);
    path.lineTo(-1.0166851908769652749e+37, -5.8361406548726660719e+37);
    path.lineTo(-1.0060401583440787299e+37, -6.2754409138998382406e+37);
    path.lineTo(-9.9462718307757392358e+36, -6.7099504677786278848e+37);
    path.lineTo(-9.8245488510153240781e+36, -7.1393387132324954823e+37);
    path.lineTo(-9.6953270841292588293e+36, -7.5632765681656217845e+37);
    ...
    path.lineTo(-9.2636736738178434088e+36, -8.7991755632195745873e+37);
    path.lineTo(-9.1054943304454646017e+36, -9.1981224471595614839e+37);
    path.lineTo(-8.9403631911814341846e+36, -9.5900475608947641721e+37);
    path.lineTo(-8.7684082887363752087e+36, -9.97465173888352879e+37);
    path.lineTo(-8.5897582896462108391e+36, -1.0351640886186602388e+38);
    path.lineTo(-8.404551367826365953e+36, -1.0720726992587613113e+38);
    path.lineTo(-8.2129288663187659978e+36, -1.1081630160834030571e+38);
    path.lineTo(-8.0150365649424372201e+36, -1.1434073536034764918e+38);
    path.lineTo(-7.811025314118806779e+36, -1.1777787362142087586e+38);
    path.lineTo(-7.6010516686970028609e+36, -1.211251101019259165e+38);
    path.lineTo(-7.3852747188273541087e+36, -1.2437987907704790919e+38);
    path.lineTo(-7.1638611605637905344e+36, -1.275397060928152084e+38);
    path.lineTo(-6.9369776899602421502e+36, -1.3060215726007537594e+38);
    path.lineTo(-6.7047992427995404518e+36, -1.335649102429287937e+38);
    path.lineTo(-6.4675020225151171631e+36, -1.3642570355270465451e+38);
    path.lineTo(-6.225267936968105035e+36, -1.3918235683037056582e+38);
    path.lineTo(-5.9782807954955371608e+36, -1.4183275056412294602e+38);
    path.lineTo(-5.7267307456874477748e+36, -1.4437487679541103361e+38);
    path.lineTo(-5.3532263698844015793e+36, -1.4787401838264262345e+38);
    path.lineTo(5.3532263698844015793e+36, 1.4787401838264262345e+38);
    return path;
}
